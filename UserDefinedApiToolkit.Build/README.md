...
and their `[HttpGet]`/`[HttpPost]`/`[HttpPut]`/`[HttpPatch]`/`[HttpDelete]` actions, and produces an `openapi.json`
(or `.yaml`) document describing routes, parameters, and response schemas.
